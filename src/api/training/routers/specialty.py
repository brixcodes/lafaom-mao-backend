...
async def list_specialties(
    ...
    specialties, total = await training_service.list_specialties(filters)
    return {
        "data": specialties,
        "page": filters.page,
...
async def create_specialty(
    ...
    existing_specialty = await training_service.get_specialty_by_name(input.name)
    ...
    specialty = await training_service.create_specialty(input)
...
async def update_specialty_route(
    ...
    specialty = await training_service.update_specialty(specialty, input)
...
async def delete_specialty_route(
    ...
    specialty = await training_service.delete_specialty(specialty)
...
async def get_active_specialties(
    ...
    specialties = await training_service.get_all_active_specialties()
