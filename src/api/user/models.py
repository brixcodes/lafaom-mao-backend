...
class Address(CustomBaseModel, table=True):
    ...
    address_type: str = Field(max_length=50, nullable=False,default=AddressTypeEnum.PRIMARY)  # e.g., 'primary', 'billing'

    country: str | None = Field(max_length=100, nullable=True)
